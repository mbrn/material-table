...
export default class MaterialTable extends React.Component {
  ...
  droppableRowsIdentifier =
    MaterialTable.defaultProps.options.draggableRowsOptions
      .droppableRowsIdentifier;
  ...
  constructor(props) {
    ...
    if (props?.options?.draggableRowsOptions?.droppableRowsIdentifier)
      this.droppableRowsIdentifier =
        props.options.draggableRowsOptions.droppableRowsIdentifier;
  ...
  onDragEnd = (result) => {
    ...
    if (this.props.options.draggableRows) {
      ...
      if (
        ...
        this.props.onRowDrop({
          ...result,
          selectedRows: this.dataManager.selectedRows,
        });
      }
    }
  ...
  onDragStart = (result) => {
    if (this.props.options.draggableRows) {
      this.toggleDraggableClass(result);
      const draggedRow = this.dataManager.selectedRows.find(
        (row) => row.tableData.id === result.source.index
      );
    ...
    >
      ...
      >
        <Droppable
          ...
          droppableId={this.droppableRowsIdentifier}
          direction="vertical"
          isCombineEnabled={
            this.props.options?.draggableRowsOptions?.isCombineEnabled
          }
        >
          {(provided, snapshot) => (
