  ...
  (0, _createClass2["default"])(MTableHeader, [{
    ...
    value: function renderSelectionHeader() {
      ...
      var isSelected = function isSelected(row) {
        ...
        return ((_row$tableData = row.tableData) === null || _row$tableData === void 0 ? void 0 : _row$tableData.checked) || false;
      };

      var allChecked = this.props.renderData.every(isSelected);
      var isIndeterminate = this.props.selectedCount > 0 && !allChecked;
      return /*#__PURE__*/React.createElement(_TableCell["default"], {
        padding: "none",
        ...
        onChange: function onChange(event, checked) {
          return _this2.props.onAllSelected && _this2.props.onAllSelected(!allChecked);
        }
      }));
    }
  }, {
